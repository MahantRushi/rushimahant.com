...
<!-- Made For Field -->
<div class="form-group col-sm-6">
    {!! Form::label('made_for', 'Made For:') !!}
    {!! Form::text('made_for', null, ['class' => 'form-control']) !!}
</div>

<!-- Description Field -->
<div class="form-group col-sm-12 col-lg-12">
    {!! Form::label('description', 'Description:') !!}
    {!! Form::textarea('description', null, ['class' => 'form-control wysi']) !!}
</div>
...
<!-- Lightbox Image Field -->
<div class="form-group col-sm-6">
    {!! Form::label('lightbox_image', 'Lightbox Image:') !!}
    {!! Form::text('lightbox_image', null, ['class' => 'form-control']) !!}
</div>

<!-- Soundcloud Link Field -->
<div class="form-group col-sm-6">
    {!! Form::label('soundcloud_link', 'Soundcloud Link:') !!}
    {!! Form::text('soundcloud_link', null, ['class' => 'form-control']) !!}
</div>

<!-- Gallery Field -->
<div class="form-group col-sm-6">
    {!! Form::label('gallery', 'Gallery:') !!}
    {!! Form::text('gallery', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('type', ['illustration' => 'illustration', 'video' => 'video', 'image' => 'image', 'soundcloud' => 'soundcloud', 'gallery' => 'gallery', 'external' => 'external'], null, ['class' => 'form-control']) !!}
</div>
